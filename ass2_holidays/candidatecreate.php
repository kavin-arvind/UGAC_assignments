...
if(isset($_POST['submit'])){
    ...
    if($pass1!=$pass2){
        ...
        $error = "";
        try {
            $sql= "INSERT INTO `login`(`user_name`, `user_email`, `user_pwd`, `user_type`) VALUES ('$username','$email','$hash','candidate')";
            // enter the commands
    ...
    if(!$error){
        $success = "success";
        header('Location: candidate.php?candi_created_now=Please login and update your details');
    }
...
<div class="container"  id="candidate singnin form">
    <section style="padding: 3%; " class="container">
        <h1 style="text-align: center;">Candidate's Sign In form</h1>
        <form action="candidatecreate.php" method="POST" class="white" style="padding: 1rem;">
